...
const Schedule: React.FC = () => {
  ...
  const fetchCompanyUsers = async () => {
    try {
      ...
      // Usar limit=1000 para garantir que todos os usuários sejam carregados
      const response = await api.get('/users', { params: { companyOnly: 'true', limit: 1000 } });
              ...
              <div className="desktop-table-view overflow-x-auto">
                <table className="min-w-full divide-y divide-neutral-200 dark:divide-slate-700">
                  ...
                  <tbody className="divide-y divide-neutral-200 dark:divide-slate-700 bg-white dark:bg-slate-800">
                    {events.map((event) => (
                      <tr key={event.id} className="odd:bg-white even:bg-neutral-50 dark:odd:bg-slate-800 dark:even:bg-slate-700 hover:bg-neutral-100 dark:hover:bg-slate-600 transition-colors">
