  ...
  if (emailSent) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 via-green-600 to-green-700 dark:from-green-900 dark:via-green-900 dark:to-green-800 px-4 relative overflow-hidden">
        ...
        <div className="max-w-md w-full backdrop-blur-xl bg-white/85 dark:bg-slate-900/75 rounded-3xl shadow-2xl border border-white/40 dark:border-white/30 p-10 relative z-10">
          ...
          <div className="text-center mb-8 relative">
            <h1 className="text-5xl font-extrabold text-slate-900 dark:text-white mb-3 drop-shadow-2xl tracking-tight">Email Enviado!</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 via-green-600 to-green-700 dark:from-green-900 dark:via-green-900 dark:to-green-800 px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full backdrop-blur-xl bg-white/85 dark:bg-slate-900/75 rounded-3xl shadow-2xl border border-white/40 dark:border-white/30 p-10 relative z-10">
        ...
        <div className="text-center mb-8 relative">
          <h1 className="text-5xl font-extrabold text-slate-900 dark:text-white mb-3 drop-shadow-2xl tracking-tight">Esqueceu a senha?</h1>
          <p className="text-slate-700 dark:text-white/90 text-lg font-medium">Digite seu email para recuperar o acesso</p>
        </div>
