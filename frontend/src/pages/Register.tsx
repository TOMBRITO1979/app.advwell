...
const Register: React.FC = () => {
  ...
  if (registered) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-100 via-green-200 to-teal-200 px-4 py-12 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-neutral-500">
              Mínimo 12 caracteres, com letra maiúscula, minúscula, número e caractere especial (!@#$%...)
            </p>
          </div>
