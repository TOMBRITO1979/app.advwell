...
const Register: React.FC = () => {
  ...
  if (registered) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 via-green-600 to-green-700 px-4 py-12 relative overflow-hidden">
        ...
        <div className="max-w-md w-full backdrop-blur-xl bg-white/85 rounded-3xl shadow-2xl border border-white/40 p-10 relative z-10">
          ...
          <div className="text-center relative">
            ...
            <h1 className="text-3xl font-extrabold text-slate-900 mb-3 drop-shadow-2xl">
              Cadastro Realizado!
            </h1>
            <p className="text-slate-700 mb-6 text-lg">
              Enviamos um email de verificação para:
            </p>
            <div className="bg-green-50 border border-white/40 rounded-lg p-4 mb-6 backdrop-blur-sm">
              <Mail className="w-5 h-5 text-primary-500 inline mr-2" />
              <span className="font-semibold text-slate-700">{userEmail}</span>
            </div>
            <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 mb-6 text-left backdrop-blur-sm">
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 via-green-600 to-green-700 px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full backdrop-blur-xl bg-white/85 rounded-3xl shadow-2xl border border-white/40 p-10 relative z-10">
        ...
        <div className="text-center mb-8 relative">
          <h1 className="text-5xl font-extrabold text-slate-900 mb-3 drop-shadow-2xl tracking-tight">Cadastro</h1>
          <p className="text-lg text-slate-700 font-medium">Crie sua conta no AdvWell</p>
        </div>
