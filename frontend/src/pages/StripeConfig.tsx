  ...
  return (
    ...
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Configuração Stripe</h1>
      </div>
            ...
            <div className="flex items-center gap-2">
              {config.isActive ? (
                <>
                  ...
                  <span className="text-green-700 dark:text-green-300 font-medium">Stripe Configurado</span>
                </>
              ) : (
                <>
                  <XCircle className="w-5 h-5 text-red-600 dark:text-red-400" />
                  <span className="text-red-700 dark:text-red-300 font-medium">Stripe Inativo</span>
                </>
              )}
            </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
        <h3 className="font-medium text-blue-900 dark:text-blue-200 mb-2">Como obter suas chaves Stripe:</h3>
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-6">
        <h3 className="font-medium text-yellow-900 dark:text-yellow-200 mb-2">URL do Webhook:</h3>
        <code className="text-sm bg-yellow-100 dark:bg-yellow-800/30 text-yellow-900 dark:text-yellow-200 px-2 py-1 rounded block break-all">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-slate-700/20 p-6 space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-slate-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            required
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-3 py-2 pr-10 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 text-gray-900 dark:text-slate-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              required={!config}
            />
            <button
              type="button"
