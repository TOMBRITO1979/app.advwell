        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow dark:shadow-slate-700/20 p-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              readOnly
              value={redirectUri}
              className="flex-1 px-4 py-2 bg-neutral-100 dark:bg-slate-700 border border-neutral-300 dark:border-slate-600 rounded-md text-neutral-700 dark:text-slate-300"
            />
            <button
              type="button"
              onClick={copyRedirectUri}
              className="inline-flex items-center gap-2 px-4 py-2 bg-neutral-100 dark:bg-slate-700 hover:bg-neutral-200 dark:hover:bg-slate-600 text-neutral-700 dark:text-slate-300 rounded-md transition-colors"
            >
